-- Fix RLS Storage Policies for Profile Avatars (Supabase Compatible)
-- This migration fixes Row Level Security issues for bucket creation and storage access
-- Compatible with Supabase's permission system
...
-- ============================================================================
-- STEP 3: CREATE STORAGE OBJECT POLICIES
-- ============================================================================
...
IMPORTANT: This version removes the ALTER TABLE statements that were causing permission errors.
*/

...
class _MediaStepState extends State<MediaStep> {
      ...
      if (result != null && result.files.isNotEmpty) {
        ...
        for (final file in result.files) {
          if (file.bytes != null) {
            ...
            final path = 'venue-images/$fileName';
            
            await _supabaseService.client.storage
                .from('venue-images')
                .uploadBinary(path, file.bytes!);

            final url = _supabaseService.getPublicUrl('venue-images', path);
    ...
    try {
      ...
      if (result != null && result.files.isNotEmpty) {
        ...
        if (file.bytes != null) {
          ...
          if (mounted) {
            context.read<VenueFormState>().updateMedia(
              floorPlan: url,
            );
          }
        }
  ...
  Future<void> _removeFloorPlan() async {
    context.read<VenueFormState>().updateMedia(floorPlan: null);
  }
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Upload images and floor plan for your venue',
            style: TextStyle(

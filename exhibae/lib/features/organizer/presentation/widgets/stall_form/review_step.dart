    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Review your stall details before submitting',
            style: TextStyle(
                  ...
                  children: [
                    ...
                    _buildSection(
                      ...
                      [
                        ...
                        _buildInfoItem('Price', '₹${formData.price}'),
                      ],
                    ),
                    const SizedBox(height: 24),
                    ...
                    _buildSection(
                      ...
                      [
                        ...
                        _buildInfoItem(
                          'Length',
                          '${formData.length}${_measurementUnitData?['symbol'] ?? ''}',
                        ),
                        _buildInfoItem(
                          'Width',
                          '${formData.width}${_measurementUnitData?['symbol'] ?? ''}',
                        ),
                        _buildInfoItem(
                          'Height',
                          '${formData.height}${_measurementUnitData?['symbol'] ?? ''}',
                        ),
                        _buildInfoItem(
                          'Area',
                          '${(formData.length * formData.width).toStringAsFixed(2)}${_measurementUnitData?['symbol'] ?? ''}²',
                        ),
                      ],
                    ),
                    const SizedBox(height: 24),
                    ...
                    _buildSection(
                      ...
                      [
                        _buildInfoItem(
                          'Total Instances',
                          formData.instances.length.toString(),
                        ),
                        _buildInfoItem(
                          'Total Value',
                          '₹${(formData.price * formData.instances.length).toStringAsFixed(2)}',
                        ),
                      ],
                    ),
                  ],
